...
const styles = StyleSheet.create({
  ...
  titleBar: {
    backgroundColor: '#1E3553', paddingVertical: theme.spacing.md,
  ...
  editBadge: { position: 'absolute', right: -2, bottom: -2, width: 36, height: 36, borderRadius: 18, backgroundColor: '#1E3553', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#FFFFFF' },
  editBadgeText: { color: '#FFFFFF', fontWeight: '800' },
  actionCol: { flex: 1, gap: theme.spacing.lg },
  primaryButton: { backgroundColor: '#1E3553', borderRadius: 12, paddingVertical: theme.spacing.md, alignItems: 'center' },
  primaryButtonText: { color: theme.colors.surface, fontWeight: '700' },

  section: { marginTop: theme.spacing['2xl'] },
  itemLine: { fontSize: 16, color: theme.colors.textPrimary, marginBottom: theme.spacing.md, lineHeight: 24 },
  card: {
  ...
  displayLabel: { color: theme.colors.textSecondary, fontWeight: '600' },
  displayValue: { color: theme.colors.textPrimary, fontWeight: '600' },
